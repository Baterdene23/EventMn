...
const NAV_LINKS = [{ href: "/events", label: "Эвентүүд" }];
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="mx-auto flex h-14 max-w-6xl items-center px-4">
        ...
        {/* Search Bar - Desktop */}
        <form onSubmit={handleSearch} className="hidden flex-1 md:block md:px-6">
        ...
        <nav className="hidden items-center gap-1 md:flex">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-56">
              <div className="px-2 py-1.5 text-xs font-medium text-muted-foreground">Төрөл</div>
              ...
              <DropdownMenuSeparator />
              <div className="px-2 py-1.5 text-xs font-medium text-muted-foreground">Байршил</div>
        ...
        {/* Spacer (mobile дээр баруун хэсгийг тогтвортой барина) */}
        ...
        <div className="flex items-center gap-2">
          {isAuthed ? (
            ...
            <>
              {/* Auth buttons: mobile дээр header дээр бүү тавь (Sheet дотор байгаа) */}
          ...
          <Sheet open={sheetOpen} onOpenChange={setSheetOpen}>
            ...
            <SheetContent side="right" className="w-72">
              ...
              <div className="mt-6 space-y-6">
                ...
                {/* Categories */}
                <div>
                  <div className="px-3 text-xs font-medium text-muted-foreground">Ангилал</div>
                ...
                {/* Locations */}
                <div>
                  <div className="px-3 text-xs font-medium text-muted-foreground">Байршил</div>
                  <nav className="mt-2 space-y-1">
                    {LOCATIONS.map((loc) => (
                      <Link
                        key={loc.slug}
